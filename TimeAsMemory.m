function [intervals,representations] = TimeAsMemory(inputtype, perceptualnoise, locationinvariant, memorynoise, networknoise,showcolumnsgraph)
...
if includephasetwo
    ...
    if modality{2}.UseBODYMapRepresentation
        [Baby{babycounter}.Phase{2}.wt1 Baby{babycounter}.Phase{2}.wt2] = backprop(Baby{babycounter}.Phase{2}.NoisyInputs,Baby{babycounter}.Phase{2}.BODYOutputs,nHidNodes,LearningRate,NEpochs,networknoiserate, momentum, 1,trackdevelopment);
    else
        [Baby{babycounter}.Phase{2}.wt1 Baby{babycounter}.Phase{2}.wt2] = backprop(Baby{babycounter}.Phase{2}.NoisyInputs,Baby{babycounter}.Phase{2}.ATOMOutputs,nHidNodes,LearningRate,NEpochs,networknoiserate, momentum, 1,trackdevelopment);
    end
    ...
    for devstage=1:NEpochs
        ...
        for k = 1:OutputLoopSize
            ...
            Baby{babycounter}.Phase{2}.TrainedOutputs{devstage}{k} = backprop_out(modality{2}.NoisyInputs,Baby{babycounter}.Phase{2}.wt1{devstage},Baby{babycounter}.Phase{2}.wt2{devstage},networknoiserate);
            if modality{2}.UseBODYMapRepresentation
